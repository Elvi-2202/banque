...
(50.00, 'Courses Supermarche', 1, 'RETRAIT'),
...
(2, 200.00, 'EN_ATTENTE', 'Proprietaire', 'Loyer', 2, 2),
...
('FR76111222333444', 'Proprietaire Appart', 2),
...
('Tentative forcee', 'TRAITEE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 5, 1);
...
(2, 2, 3, 2, 'emission virement', '82.45.12.3', 'App Mobile iOS'),
(3, 3, 1, 3, 'Analyse Fraude', '10.0.0.22', 'Scan automatique'),
(4, 4, 5, 4, 'echec authentification', '176.12.34.56', '3 tentatives erronees');
